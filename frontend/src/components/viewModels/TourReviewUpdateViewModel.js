...
import { updateReview, getReviewById_Tour } from '../models/ReviewModel';
...
export default function (reviewID) {
  ...
  const loadReview = async () => {
    try {
      review.value = await getReviewById_Tour(reviewID);
      tour.value = await getTourById(review.value.tour_id);
