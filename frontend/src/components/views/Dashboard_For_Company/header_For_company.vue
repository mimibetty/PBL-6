<template>
  <div :class="['container-fluid header p-0', { 'scrolled': state.isScrolled }]">
    <nav class="navbar navbar-expand-lg navbar-light px-4 px-lg-5 py-3 py-lg-0">
      <div class="navbar-brand p-0 logo-1" @click="handleButtonClick('home', '/business')">
        <h1 class="m-0">
      ...
      <div class="collapse navbar-collapse text-lg-end" id="navbarCollapse">
        <div class="navbar-nav ms-auto py-0">
          <button class="nav-item nav-link" :class="{ active: state.activeButton === 'home' }"
          ...
          <div class="nav-item dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-end m-0">
              <button class="dropdown-item" @click="handleButtonClick('profile', '/Profile_Page')">Settings</button>
