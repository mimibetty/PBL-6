<template>
          ...
          <div class="filter-section">
            ...
            <div v-if="activeOption === 'establishment-type-options'" class="options">
                ...
                <div class="option">
                    ...
                    <label for="bar-pubs">Bar & Pubs</label>
                </div>
                <div class="option">
                ...
                <div class="option">
                    ...
                    <label for="delivery-only">Delivery Only</label>
                </div>
            </div>
            ...
            <div v-if="activeOption === 'meals-options'" class="options">
                <div class="option">
                    ...
                    <label for="breakfast" class="label-1">Breakfast</label>
                </div>
                <div class="option">
                    <input type="checkbox" id="brunch" />
                    <label for="brunch" class="label-1">Brunch</label>
                </div>
                <div class="option">
                    <input type="checkbox" id="lunch" />
                    <label for="lunch" class="label-1">Lunch</label>
                </div>
                <div class="option">
                    <input type="checkbox" id="dinner" />
                    <label for="dinner" class="label-1">Dinner</label>
                </div>
            </div>
            ...
            <div v-if="activeOption === 'price-options'" class="options">
              <div class="currency-options">
                <label><input type="radio" name="currency" value="VND" checked @change="handleCurrencyChange('VND')"> VNĐ</label>
                <label><input type="radio" name="currency" value="USD" @change="handleCurrencyChange('USD')"> USD</label>
              </div>
  ...
  import destinationViewModel from '../viewModels/city_Restaurant_ListViewModel';
