<template>
    ...
    <div class="main-container">
      <div class="review-container">
        <h2>Hotel Update - For {{ destination.name }}</h2>
        <div class="review-title-section">
            <p class="question-title">Property Amenities</p>
            <input
              v-model="destination.hotel.property_amenities"
              type="text"
              class="title-input"
            />
        </div>
        <div class="review-title-section">
            ...
            <textarea
              v-model="destination.hotel.room_features"
              class="review-text"
              ></textarea>
        </div>
        <div class="review-title-section">
            ...
            <input
              v-model="destination.hotel.room_types"
              type="text"
              class="title-input"
            />
        </div>
        <div class="review-title-section">
            ...
            <input
              v-model="destination.hotel.hotel_class"
              type="number"
              class="title-input"
            />
        </div>
        <div class="review-title-section">
            ...
            <input
              v-model="destination.hotel.hotel_styles"
              type="text"
              class="title-input"
            />
        </div>
        <div class="review-title-section">
            ...
            <input
              v-model="destination.hotel.Languages"
              type="text"
              class="title-input"
            />
        </div>
        <div class="review-title-section">
            ...
            <input
              v-model="destination.hotel.phone"
              type="text"
              class="title-input"
            />
        </div>
        <div class="review-title-section">
            ...
            <input
              v-model="destination.hotel.email"
              type="email"
              class="title-input"
            />
        </div>
        <div class="review-title-section">
            ...
            <input
              v-model="destination.hotel.website"
              type="text"
              class="title-input"
            />
        </div>
          ...
          <button class="submit-button" @click="updateHotel">Update Hotel</button>
      </div>
    </div>
  </template>
