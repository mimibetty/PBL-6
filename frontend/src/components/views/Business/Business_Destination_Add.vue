<template>
    ...
    <div class="main-container">
      <div class="review-container">
        <h2>Destination Create for Business</h2>
        ...
        <div class="photo-preview-wrapper">
            <div v-for="(photo, index) in previewImages" :key="index" class="photo-preview-row">
            <img :src="photo" class="preview-img" />
            <button class="remove-button" @click.stop="removeImage(index)">-</button>
            </div>
        </div>
  
        <!-- Upload input box remains at the bottom -->
        <div class="photo-upload-box">
            <input type="file" @change="handleImageUpload" multiple class="photo-input" />
            <p class="photo-upload-text" v-if="!previewImages.length">
          ...
          <button class="submit-button" @click="addDestination">Create Place</button>
      </div>
    </div>
  </template>
