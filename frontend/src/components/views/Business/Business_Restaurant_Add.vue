<template>
    ...
    <div class="main-container">
      <div class="review-container">
        <h2>Restaurant Create - For {{ destination.name }}</h2>
        <div class="review-title-section">
            <p class="question-title">Cuisine</p>
            <input
              v-model="restaurant.restaurant.cuisine"
              type="text"
              class="title-input"
            />
        </div>
        <div class="review-title-section">
            ...
            <textarea
              v-model="restaurant.restaurant.special_diet"
              class="review-text"
              ></textarea>
        </div>
        <div class="review-title-section">
            ...
            <input
              v-model="restaurant.restaurant.feature"
              type="text"
              class="title-input"
            />
        </div>
        <div class="review-title-section">
            ...
            <input
              v-model="restaurant.restaurant.meal"
              type="text"
              class="title-input"
            />
        </div>
          ...
          <button class="submit-button" @click="addRestaurant">Create Restaurant</button>
      </div>
    </div>
  </template>
  ...
  const {
    ...
    onMounted(() => {
        ...
        if (destination.value && destination.value.id) {
            restaurant.value.id = destination.value.id;
        } else {
