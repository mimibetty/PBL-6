                ...
                <div class="container-fluid overall">
                    ...
                    <div class="container-fluid frame-main d-flex flex-column justify-content-center align-items-center gap-3">
                        ...
                        <div class="container-fluid frame-info">
                            ...
                            <div class="container-fluid">
                                <div class="description custom form-floating mt-3">
                                    <textarea type="text" class="form-control description" id="tourName" placeholder="Description" name="tourName" v-model="restaurant.restaurant.feature"/>
                        ...
                        <div class="frame-name container-fluid dest-location d-flex justify-content-center ">
                            ...
                            <div class="container-fluid">
                                <div class="custom form-floating mt-3">
                                    <input type="text" class="form-control" id="tourName" placeholder="Tour Name" name="tourName" v-model="restaurant.restaurant.special_diet">
                            ...
                            <div class="container-fluid">
                                <div class="custom form-floating mt-3">
                                    <input type="text" class="form-control" id="tourName" placeholder="Tour Name" name="tourName" v-model="restaurant.restaurant.meal">
