<template>
    <div class="tour-management">
      ...
      <div v-else class="detail-destination">
        ...
        <div v-if="currentTourDetail " class="destination-info">
          <section class="info-section destination-detail">
            ...
            <div class="detail-card">
              <div class="detail-item">
                ...
                <span><strong>Name:</strong>{{ currentTourDetail.name || "N/A" }}</span>
              </div>
              <div class="detail-item">
                <i class="icon-info"></i>
                <span
                  ...
                  {{
                    currentTourDetail.description || "No description available"
                  }}</span
                >
              </div>
              <div class="detail-item">
                ...
                <span
                  ...
                  {{ getUserName(currentTourDetail.user_id) || "N/A" }}</span
                >
              </div>
              <div class="detail-item">
                <i class="icon-city"></i>
                <span
                  ><strong>City:</strong>
                  {{ getCityName(currentTourDetail.city_id) || "N/A" }}</span
                >
              </div>
              <div class="detail-item">
                ...
                <span
                  ...
                  {{ currentTourDetail.duration || "N/A" }}</span
                >
              </div>
            </div>
          </section>
          ...
          <section class="info-section">
            ...
            <div v-if="currentTourDetail.destinations" class="info-card">
              <div
                class="info-item"
                v-for="(destination, index) in currentTourDetail.destinations"
                :key="index"
              >
                <i class="icon-info"></i>
                <span>
            ...
            <div class="action-buttons">
              <button @click="showUpdateForm(currentTourDetail.id)">
                <i class="icon-update"></i> Update Tour
              </button>
              <button @click="deleteTour(currentTourDetail.id)">
  ...
  onMounted(async () => {
    await loadCity();
    await loadUsers();
    currentTourDetail.value =await getTour(tourID);
