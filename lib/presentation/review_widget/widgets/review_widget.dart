...
class ReviewWidget extends StatelessWidget {
        ...
        children: [
            ...
            child: Row(
              ...
              children: [
                ...
                Obx(
                  () {
                    print(
                        'Dropdown selected language: ${controller.selectedLanguage.value}');
                    return DropdownButton<String>(
                      ...
                      onChanged: (String? newValue) {
                        if (newValue != null) {
                          ...
                          print(
                              'Updated Language: ${controller.selectedLanguage.value}');
          ...
          Obx(() {
            if (controller.isLoading.value) {
              print(
                  "isLoading state: " + controller.isLoading.value.toString());
                              ...
                              Expanded(
                                child: Text(
                                  ...
                                  overflow: TextOverflow
                                      .ellipsis, // Cắt bớt nếu tiêu đề quá dài
                                ),
                              ),
                            ],
                          ),
                            ...
                            children: [
                              ...
                              Expanded(
                                child: Text(
                                  ...
                                  overflow: TextOverflow
                                      .ellipsis, // Cắt bớt nếu nội dung quá dài
  ...
  void _showFilterDialog(BuildContext context) {
    ...
    final List<String> timesOfYear = [
      'Mar-May',
      'Jun-Aug',
      'Sep-Nov',
      'Dec-Feb'
    ];
    final List<String> typesOfVisit = [
      'Families',
      'Couples',
      'Friends',
      'Solo',
              ...
              actions: [
                ...
                ElevatedButton(
                  onPressed: () {
                    ...
                    print(
                        "selected rating : ${selectedRating}  selectedTimeOfYear : ${selectedTimeOfYear} selectedTypeOfVisit : ${selectedTypeOfVisit}");
